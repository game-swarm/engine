...
export interface WorldConfig {
    ...
    visibility: {
        ...
        public_spectate: boolean;
        spectate_delay: number;
        replay_privacy: ReplayPrivacy;
    };
    resource_types: ResourceDef[];
    source_types: SourceDef[];
    actions: {
        costs: Record<string, ResourceCost>;
    };
    mods: ModConfig[];
}
...
export {};
//# sourceMappingURL=types_template.d.ts.map